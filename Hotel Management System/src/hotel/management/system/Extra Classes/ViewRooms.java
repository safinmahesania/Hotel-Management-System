	...
	btnView.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                if("All".equals(choice.getSelectedItem())){
                    SQL = "select * from Room where availability = 'Available'";
                }else{
                    SQL = "select * from Room where availability = 'Available' AND bed_type = '"+choice.getSelectedItem()+"'";
                }
